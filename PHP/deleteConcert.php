...
<html>
  ...
  <body>
    <div class="form" style="max-width: 800px">
      ...
      <?php
        $sql = "DELETE FROM Concerti WHERE idConcerto = '$id'";
        if($conn->query($sql)) echo "<div align='center'><b> Concerto cancellato </b> </div>";
        else echo "<div align='center'><b> Concerto non cancellato </b> </div>";
      ?>
